...
def main_1():
    try:
        ...
        # Print statement showing molar mass
        print(f'There are {molar_mass_rounded} grams/mole')

        # Recieve grams from user
        grams = float(input('How many grams of the existing formula is there? '))

        # Call functions to get moles and round
        moles = grams/molar_mass_rounded
        moles_rounded = round(moles, 5)
