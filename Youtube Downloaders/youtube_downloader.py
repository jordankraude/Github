...
# gui coding
root = Tk()
root.title("Personal Youtube Downloader")
root.iconbitmap(r"C:\Users\Jordan\Desktop\Downloaded Icons\finance_business_money_investment_dollar_icon_188617.ico")
root.geometry("500x250")

# main icon section
file = PhotoImage(file=r"C:\Users\Jordan\Desktop\Downloaded Icons\—Pngtree—youtube logo icon_3560543.png")
headingIcon = Label(root, image=None)
